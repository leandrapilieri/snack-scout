    ...
    <div className="container-pad space-y-7">
      ...
      <section>
        ...
        <div className="grid gap-3">
          {filtered.length ? (
            filtered.map((snack) => <ProductCard key={snack.id} snack={snack} />)
          ) : (
            <EmptyState title="No matches yet" text="Try another brand name, snack type, or browse trending picks." />
          )}
        </div>
      </section>
    </div>
