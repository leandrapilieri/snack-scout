...
export default function LandingPage() {
  return (
    <div className="container-pad space-y-10">
      <section className="soft-panel space-y-5 pt-2">
        <p className="text-sm font-medium text-primary">Snack Scout</p>
        <h1 className="text-3xl font-semibold leading-tight md:text-4xl">Know in seconds if a snack is a great pick for your kid.</h1>
        <p className="max-w-xl text-stone-600">Simple verdicts, allergen awareness, and better swaps while you shop.</p>
        ...
        <div className="grid gap-3 md:grid-cols-3">
          {[
            ...
            <Card key={step} className="flex items-start gap-3">
              <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-primary/15 text-primary">{index + 1}</div>
